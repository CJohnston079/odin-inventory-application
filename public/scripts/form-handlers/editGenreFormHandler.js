...
const form = document.querySelector("#edit-genre");
const genreInput = document.querySelector("#genre");
const descriptionInput = document.querySelector("#description");
const genreName = document.querySelector("#title").textContent;

const validationState = { genre: null, description: null };

const validators = {
	genre: async () => await validateGenre(genreInput, genreName),
